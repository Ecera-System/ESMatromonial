...
const FileMessage = ({ message, isOwnMessage }) => {
    ...
    return (
      <div className="max-w-sm">
        <div className="relative group rounded-lg overflow-hidden bg-gray-100">
          ...
          <div className="hidden w-full h-40 bg-gray-200 items-center justify-center">
  ...
  return (
    <div className={`max-w-xs p-4 rounded-lg border shadow-sm ${
      isOwnMessage 
      ...
      <div className="flex space-x-2">
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={handleView}
          className="flex-1 px-3 py-2 bg-blue-50 text-blue-600 rounded-lg text-xs font-medium hover:bg-blue-100 transition-colors flex items-center justify-center space-x-1"
        >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={handleDownload}
          className="flex-1 px-3 py-2 bg-green-50 text-green-600 rounded-lg text-xs font-medium hover:bg-green-100 transition-colors flex items-center justify-center space-x-1"
        >
