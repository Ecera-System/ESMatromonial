          ...
          <ul className="space-y-4">
            {tabData[activeTab].map((req) => {
              ...
              return (
                <li
                  key={req._id}
                  className="p-3 sm:p-4 rounded-xl border border-gray-200 hover:shadow-sm transition-shadow"
                >
                      ...
                      {activeTab === "Received" && req.status === "pending" && (
                        <>
                          ...
                          <button
                            ...
                            className="inline-flex items-center justify-center w-full sm:w-auto px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-50"
                          >
