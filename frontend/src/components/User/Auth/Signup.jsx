          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600 font-medium">
              ...
              <button
                ...
                className="font-bold text-transparent bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text hover:from-purple-700 hover:to-pink-700 transition-all duration-300 hover:underline"
              >
                Sign in here
              </button>
            </p>
