  ...
  return (
    <>
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
          <div className="flex items-center space-x-4">
            ...
            />
            <div>
              <h3 className="text-lg font-semibold text-gray-900">{report.reportedUser.name}</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-gray-600">By {report.reportedBy.name}</span>
          </div>
      ...
      <ConfirmationModal
        ...
        confirmButtonClass={actionType === 'disable' ? 'bg-red-600 hover:bg-red-700' : 'bg-indigo-600 hover:bg-indigo-700'}
      />
    </>
  );
};
