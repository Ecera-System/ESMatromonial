      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-4">{stats.pending}</h3>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-4">{stats.underReview}</h3>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-4">{stats.resolved}</h3>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-4">{stats.dismissed}</h3>
          </div>
        </div>
