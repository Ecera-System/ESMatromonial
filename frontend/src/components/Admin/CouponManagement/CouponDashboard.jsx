...
const CouponDashboard = () => {
  ...
  const getStatusColor = (coupon) => {
    ...
    if (new Date(coupon.expiresAt) < new Date()) return 'bg-red-100 text-red-800';
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
          <div className="flex items-center space-x-4">
            <div>
              ...
              <p className="text-gray-600">Create, manage, and track coupon performance</p>
            </div>
                      ...
                      {coupons.map((coupon) => (
                        <tr key={coupon._id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            <div className="text-sm text-gray-500 capitalize">{coupon.type}</div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm text-gray-900">
              ...
              {pagination.totalPages > 1 && (
                <div className="px-6 py-4 border-t border-gray-200 flex justify-between items-center">
                  <div className="text-sm text-gray-600">
                    Showing {Math.min((pagination.currentPage - 1) * 10 + 1, pagination.total)} to {Math.min(pagination.currentPage * 10, pagination.total)} of {pagination.total} results
                  </div>
