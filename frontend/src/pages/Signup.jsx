...
const Signup = () => {
  ...
  const [showVerificationPopup, setShowVerificationPopup] = useState(false); // New state for popup
            ...
            <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-700 dark:to-gray-800 rounded-xl border border-purple-100 dark:border-gray-600">
              ...
              <div className="text-sm">
                ...
                >
                  ...
                  <button
                    type="button"
                    className="text-purple-600 hover:text-purple-500 font-semibold hover:underline"
                  >
                    Terms & Conditions
                  </button>{" "}
                  and{" "}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 sm:p-8 max-w-md w-full text-center transform transition-all duration-300 scale-100 opacity-100">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3 rounded-lg font-semibold hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-md"
            >
              Go to Dashboard
            </button>
          </div>
