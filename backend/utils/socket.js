  ...
  io.on("connection", async (socket) => {
    ...
    socket.on("send-message", async (data) => {
      ...
      try {
        ...
        console.log("Backend: Other participants for notification:", otherParticipants);
        for (const participant of otherParticipants) {
          const participantSocketId = connectedUsers.get(
            participant._id.toString()
          );
          console.log(`Backend: Participant ${participant._id} socket ID: ${participantSocketId}`);
          ...
          if (participantSocketId) {
            ...
            console.log("Backend: Emitting message-notification with data:", notificationData);
            io.to(participantSocketId).emit("message-notification", notificationData);
